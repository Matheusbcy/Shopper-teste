-- Active: 1683993696463@@127.0.0.1@3306@shoppe-teste
...
( 
	...
	sales_price decimal(9,2) NOT NULL # PRE�O DE VENDA DO PRODUTO // ESSE SEMPRE MAIOR QUE O COST_PRICE // NOVO VALOR NÂO PODE SER 10% MAIOR ou MENOR QUE O ANTIGO
);

INSERT INTO products VALUES (16,'AZEITE  PORTUGUÉS  EXTRA VIRGEM GALLO 500ML',18.44,20.49);
